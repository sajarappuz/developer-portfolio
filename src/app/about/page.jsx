...
const About = () => {
  ...
  <div key={index} className='w-[400px] md:w-[250px] h-[200px] md:h-[200px] flex flex-col items-center justify-center rounded-[40px] bg-black text-white gap-10 border-solid border-[2px] '>
